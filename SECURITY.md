...
אנו מקפידים על תקני OWASP ועל נהלים הבאים:

- ✅ הימנעות מהזרקות קלט (XSS, SQLi)
- ✅ הגנה על מפתחות וסודות (.env + GitHub secrets)
- ✅ אימות הרשאות לפי תפקידים
- ✅ CI עם בדיקות אבטחה אוטומטיות
- ✅ קוד פתוח רק אחרי סריקה ידנית

לדיווח על פגיעות: security@finflow.co.il
